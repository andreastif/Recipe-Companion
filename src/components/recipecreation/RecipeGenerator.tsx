...
import { recipeButtonStyle, wideRecipeButtonStyle } from "../inspirationtab/muiStyles.ts";
                ...
                <>
                  <div className="my-4 recipe-box-shadow recipe-grouping">
                    ...
                    {isRecipeSavedLoading ? (
                      <Button type="button" variant="contained" sx={wideRecipeButtonStyle()}>
