...
const RecipeImage: React.FC<RecipeImageProps> = ({height, imageId}) => {
    ...
    if (loading) {
        return (
            <div style={{height: `${height}px`, width: "100%", objectFit: "cover"}} className="bg-dark d-flex align-items-center justify-content-center">
    ...
    return (
        <img src={imgUrl} alt="food" style={{height: `${height}px`, width: "100%", objectFit: "cover"}}/>
    )
}
